...
[![Crypto Lab CI](https://github.com/YOUR_USERNAME/crypto-lab/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/crypto-lab/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/YOUR_USERNAME/crypto-lab.git
cd crypto-lab
```
